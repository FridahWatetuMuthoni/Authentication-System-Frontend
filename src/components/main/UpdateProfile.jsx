...
function UpdateProfile() {
  ...
  return (
    <>
      <button
        className="py-1.5 px-1.5 mt-10 text-center text-sm border border-indigo-500 rounded-md text-content  hover:bg-indigo-400 hover:text-gray-100 dark:text-gray-200 dark:bg-violet-700"
        type="submit"
      >
